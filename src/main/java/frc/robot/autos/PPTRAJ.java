...
public final class PPTRAJ {
    ...
    public final static PathConstraints defaultPathCon = new PathConstraints(1.75, 2.5);
    ...
    public final static PathPlannerTrajectory balance15M1 = PathPlanner.loadPath("15PATHOVER", defaultPathCon);
